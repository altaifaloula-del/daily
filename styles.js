...
/* v16.1: لون تحويم من الرموز لا مثبّتاً — كان #2E2823 يجعل الزر أسود في الوضع الفاتح */
.btn:hover:not(:disabled){border-color:var(--brass-d);background:color-mix(in srgb,var(--brass) 6%,var(--ink3));box-shadow:var(--sh-2)}
